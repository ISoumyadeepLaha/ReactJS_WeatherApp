...
const Search = ({ searchData, eventHandler, searchWeatherHandler }) => {
  ...
  return (
    <div className="flex justify-center">
      ...
      />
      <button className="uppercase p-4 w-2/12 bg-[#8D3DAF] text-white-shade  rounded-md text-lg hover:bg-[#5e2975] hover:scale-95 hover:ease-in-out hover:duration-300"
